...
<div>
	...
	<div id="contenu1"> 
		<div class="menu a">
		<span class="menutop"><a href="fonction.php">&nbsp;&nbsp;<strong>Ajouter une fonction</strong>&nbsp;&nbsp;</a></span>&nbsp;|
		<span class="menutop"><a href="liste_fonction.php">&nbsp;&nbsp;<strong>Liste des fonctions</strong>&nbsp;&nbsp;</a></span>
		</div>
		</br></br></br></br></br>

		<form name="form" action="function_add_fonction.php" method="POST">


			<table align="center">
				<tr>
					<td>
						<label for="fonction">Nom fonction:</label>
					</td>
					<td>
						<input type="text" name="libelleFonction" id="codserv" required>
					</td>
