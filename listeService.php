...
<div>
	...
	<div id="contenu1"> 
		...
		<tr><th>Suppreimer</th><th>Libelle Service</th><th>Chef de Service</th>
            
		<?php
		$recherche="SELECT * FROM services" ;
		...
		echo'<tr>';
		echo'        
        <td><a href="function_supprimer_stagiaire.php?suppstag='.$data['libelleserv'].'
        "onclick="return(confirm(\'Etes-vous sur de vouloir supprimer ce stagiaire?\'));" >Supprimer</a></td>
        
        <td>'.strtoupper($data['libelleserv']).'</td>
        
            <td>'.strtoupper($data['chefserv']).'</td>';
