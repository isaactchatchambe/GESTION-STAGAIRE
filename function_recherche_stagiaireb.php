		...
		<div>
			...
			<?php
				...
				if (strlen($recherche)<3){
                    ...
                    inner join 
                    encadreurs 
                    ON stagiaires.matricule = encadreurs.matricule 
                    inner join services 
                    ON stagiaires.codeserv=services.codeserv 
                    WHERE upper(nom) or lower(nom) LIKE '%$recherche%' 
                    ORDER BY nom";
                    
                    
					$eyano=$connexion->prepare($luka);
                    
                    $eyano->execute(array($recherche));
					...
					if ($compter<=0){
						...
						while($donnee=$eyano->fetch())
                        
                        {?>
						<tr><td><?php echo $donnee['numstagiaire']; ?></td><td style="padding-left:5px; padding-right:5px;">
                            
                            <?php echo strtoupper($donnee['nomenc']); ?></td><td style="padding-left:5px; padding-right:5px;" >
                            
                            <?php echo strtoupper($donnee['libelleserv']); ?></td><td style="padding-left:5px; padding-right:5px;" >
                            
                            <?php echo strtoupper($donnee['nom']); ?></td><td style="padding-left:5px; padding-right:5px;" >
                            
                            <?php echo strtoupper($donnee['prenom']); ?></td><td>
                            
                            <?php echo strtoupper($donnee['sexe']); ?></td><td style="padding-left:5px; padding-right:5px;" >
                            
                            <?php echo $donnee['debutstage']; ?></td><td style="padding-left:5px; padding-right:5px;" >
                            
                            <?php echo $donnee['finstage']; ?></td><td style="padding:5px;">
                            
                            <img width="60" height="70" src="photos/<?php echo $donnee['photo']; ?> "></td></tr>
